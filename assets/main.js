  ...
  const I18N = {
    es: {
      ...
      'about.body1': 'ISMAEL S.A. es una empresa de San Juan especializada en logística minera, transporte minero y soporte operativo para la industria minera, el petróleo, el gas y grandes obras. Operamos con flota propia para minería en la Cordillera de los Andes, con más de 20 años de presencia en la provincia.',
    ...
    en: {
      ...
      'about.body1': 'ISMAEL S.A. is a San Juan-based company specializing in mining logistics, mining transport and operational support for the mining, oil, gas and major construction industries. We operate our own fleet for mining in the Andes, with over 20 years of presence in the province.',
